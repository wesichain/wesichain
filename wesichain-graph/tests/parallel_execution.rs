...
async fn test_parallel_execution() {
    ...
    let builder = GraphBuilder::<ParallelState>::new()
        ...
        .add_node("A", SleepyNode { id: "A".to_string(), delay_ms: 10 })
        .add_node("B", SleepyNode { id: "B".to_string(), delay_ms: 200 })
        .add_node("C", SleepyNode { id: "C".to_string(), delay_ms: 200 })
        .add_node("D", SleepyNode { id: "D".to_string(), delay_ms: 10 })
        .set_entry("A")
    ...
    assert!(duration < Duration::from_millis(350), "Execution took {:?}, expected < 350ms (parallel)", duration);
