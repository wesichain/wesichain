...
async fn test_parallel_merge() {
    ...
    let builder = GraphBuilder::<MergeState>::new()
        ...
        .add_node("A", AppendingNode { id: "A".to_string(), delay_ms: 10 })
        .add_node("B", AppendingNode { id: "B".to_string(), delay_ms: 50 })
        .add_node("C", AppendingNode { id: "C".to_string(), delay_ms: 50 })
        .set_entry("A")
